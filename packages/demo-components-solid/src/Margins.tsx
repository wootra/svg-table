import SVGTable, { CellProps, SVGRenderElement, TableProps } from '@shjeon0730/svg-table-solid';
...
const rectCell = (width: number, fill: string): CellProps => ({
	content: (<rect x={0} y={0} width={width} height={30} fill={fill} />) as SVGRenderElement,
});
